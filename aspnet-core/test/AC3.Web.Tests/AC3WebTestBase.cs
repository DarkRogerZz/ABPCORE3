...
{
    public abstract class AC3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AC3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AC3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AC3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AC3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AC3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AC3DbContext, Task<T>> func)
        {
            T result;
